...
//
//    private String username; //probably email address
...
public class UserDetailDTO extends User {
    ...
    public UserDetailDTO(String username, String password, Collection<? extends GrantedAuthority> authorities, String user_id) {
        super(username, password, authorities);
